...
export const SAMPLE_SUBJECTS = {
  ...
  iot: {
    ...
    '4': [
      ...
      { id: 'iotjackpot', name: 'Intro to Cyber Law theory', teacher: 'Prof. Priyanka Mam' },
      { id: 'iotsystem', name: '[MDM] Artificial Intelligence theory', teacher: 'Prof. Neha Mam' },
      { id: 'cloud', name: 'AAD Practical', teacher: 'Prof. Roshni Mam' },
      { id: 'iot_app', name: 'DCS & SP Practical', teacher: 'Prof. Sawarkar Mam' },
      { id: 'dsa_prac', name: 'DSA Practical', teacher: 'Prof. Sarad Mam' },
    ],
    '5': [
